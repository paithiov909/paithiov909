...
> My own curated list of documentations about R.
>
> If seeking more comprehensive information about Rstats, visit [Big Book of R](https://www.bigbookofr.com/). In case you would like to search across popular API documentations, try to use [DevDocs](https://devdocs.io/) or [METACRAN](https://www.r-pkg.org/).

[Programmable Search](https://r-refs-paithiov909.netlify.app/cse.html) is also available.
...
- [深層学習 · 深層学習](https://atcold.github.io/pytorch-Deep-Learning/ja/)
- [jamoviで学ぶ心理統計](https://bookdown.org/sbtseiji/lswjamoviJ/)
...
- [はじめに — Python早見帳](https://chokkan.github.io/python/)
